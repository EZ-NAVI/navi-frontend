    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.box}>
          ...
          >
            <Text style={styles.checkText}>{consents.personal ? "☑" : "☐"} 위 내용에 동의합니다</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.box}>
          ...
          >
            <Text style={styles.checkText}>{consents.location ? "☑" : "☐"} 위 내용에 동의합니다</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.box}>
          ...
          <TouchableOpacity
            ...
            onPress={() => toggle("fcm")}
          >
            <Text style={styles.checkText}>{consents.fcm ? "☑" : "☐"} 위 내용에 동의합니다</Text>
          </TouchableOpacity>
        </View>
        ...
        {!isParent && (
          <View style={styles.box}>
            ...
            >
              <Text style={styles.checkText}>{consents.guardian ? "☑" : "☐"} 법정대리인 동의에 동의합니다</Text>
            </TouchableOpacity>
          </View>
        )}
        ...
        <TouchableOpacity
          ...
          onPress={setAll}
        >
          <Text style={styles.allAgreeText}>{allAgreed ? "✔ 모든 항목에 동의 완료" : "전체 항목 모두 동의하기"}</Text>
        </TouchableOpacity>
